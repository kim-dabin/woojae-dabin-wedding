...
- `photo-01.jpg` - `photo-29.jpg`: 갤러리 사진입니다. 각 사진의 `src`를 `"assets/photos/photo-01.jpg"`처럼 채웁니다.
- `photo-08.jpg`: 예전 8번째 사진 자리입니다. 파일은 교체되어 있지만 현재 `WEDDING_DATA.photos`에는 넣지 않아 사이트에는 노출되지 않습니다.
